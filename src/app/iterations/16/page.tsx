...
// Iteration 16: same as iteration 15, but the intro's 5-image layout cross-fades
// in and out in place every 2 seconds instead of flying tiles on/off screen.
// Clicking anywhere leaves the intro and drops into the grid of all images.
export default async function IterationSixteen() {
