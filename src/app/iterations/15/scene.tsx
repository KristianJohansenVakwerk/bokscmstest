...
export default function Scene({
  ...
  return (
    <div className="relative h-screen w-full">
      ...
      {/* Spinning wheel: one rotation every 2s, cueing the next layout shift. */}
      <div className="pointer-events-none absolute bottom-0 right-0 p-5">
        <div
          className="h-24 w-24 animate-spin rounded-full border-4 border-zinc-300 border-t-zinc-800"
