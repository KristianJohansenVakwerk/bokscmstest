...
// Iteration 20: same as iteration 19 (inline caption-then-image pairs), but the
// grid rows flow left-aligned instead of justified.
export default async function IterationTwenty() {
