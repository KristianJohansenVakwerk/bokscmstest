...
// Iteration 21: same three.js intro as iteration 18, but the grid is a centered,
// wrapping flow of small (60px) thumbnails — each row centered on screen —
// keeping the lazy-load and hover preview.
export default async function IterationTwentyOne() {
